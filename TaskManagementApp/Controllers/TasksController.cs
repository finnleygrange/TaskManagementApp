...
namespace TaskManagementApp.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,DueDate,Priority,IsCompleted")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,DueDate,Priority,IsCompleted")] Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
